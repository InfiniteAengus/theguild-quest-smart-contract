    ...
    describe("Integration Tests", function () {
        ...
        describe("Account", function () {
            ...
            it("Tier counts should be at 0 since there are no referrals to this account", async function () {
                ...
                expect(tierCounts).to.deep.equal([0n, 0n, 0n, 0n, 0n, 0n]);
            });
            ...
            it("The protocol should be able to set the tier level of the account while updating the referrers above", async function () {
                ...
                expect(tierCount).to.deep.equal([0n, 4n, 0n, 0n, 0n, 0n]);
                ...
                expect(tierCount).to.deep.equal([0n, 3n, 0n, 1n, 0n, 0n]);
            ...
            it("Should not be able to setTier for an account that does not have any referrals within some of the depths", async function () {
                ...
                expect(tierCount).to.deep.equal([0n, 2n, 1n, 1n, 0n, 0n]);
                ...
                expect(tierCount).to.deep.equal([0n, 2n, 0n, 1n, 0n, 0n]);
                ...
                // Account 1's should have a change at level 2
                expect(tierCount).to.deep.equal([0n, 1n, 2n, 1n, 0n, 0n]);
                ...
                expect(tierCount).to.deep.equal([0n, 1n, 0n, 1n, 0n, 0n]);
                ...
                expect(tierCount).to.deep.equal([0n, 0n, 3n, 1n, 0n, 0n]);
                ...
                expect(tierCount).to.deep.equal([0n, 1n, 1n, 1n, 0n, 0n]);
            });
