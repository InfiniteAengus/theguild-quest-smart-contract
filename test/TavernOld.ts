...
//             const { tavern, questImpl, escrowImpl } = await loadFixture(
//                 deployTavernFixture
//             );

//             expect(await tavern.escrowImplementation()).to.equal(
//                 escrowImpl.target
//             );
...
//                 const { tavern, seeker, solver } = await loadFixture(
//                     deployTavernFixture
//                 );

//                 const questCreation = await tavern.startNewQuest(
//                     solver.address,
//                     seeker.address,
//                     100n,
//                     ""
...
//                 if (log !== undefined) {
//                     let eventLog = tavern.interface.parseLog({
...
//                 expect(questCreation)
//                     .to.emit(tavern, "QuestCreated")
//                     .withArgs([seeker, solver, quest, escrow]);
//             });
