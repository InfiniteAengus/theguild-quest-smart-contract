...
library TaxCalculator {
    ...
    function _calculateSolverTax(ITaxManager _taxManager, uint256 _paymentAmount) 
        internal 
        view
        returns 
    (
        ...
        referralTax_ = (_paymentAmount * solverFees.referralRewards) /
            taxRateDivisor;

        platformTax_ = (_paymentAmount * solverFees.platformRevenue) /
            taxRateDivisor;

        platformTreasuryTax_ = (_paymentAmount * solverFees.platformTreasury) /
            taxRateDivisor;
