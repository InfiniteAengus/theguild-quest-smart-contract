...
interface IRewarder {
    ...
    function processResolutionNative(uint32 seekerId, uint32 solverId, uint8 solverShare) external payable;
    function processResolutionToken(uint32 seekerId, uint32 solverId, uint8 solverShare, address token, uint256 payment) external;
